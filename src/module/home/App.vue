...
<script>
    ...
    export default {
        ...
        methods: {
                        ...
                        success: function(res){
                            ...
                            if(res.respCode == '000000'){
                                if(res.data.status == 'Y'){
                                    var link = '/api/static/bjym/module/init.html?token='+_this.token+'&userId='+_this.userId+'&productId='+productId +'&productName='+ productName +'&productUserId='+ productUserId+'&repay='+_this.repay;
                                    window.location.href = link;
                                    
                                } else {
                                    if(res.data.simplifyAuth == 'Y' && res.data.idcardOrActive == 'N'){
                                        window.location.href = '/api/static/xmy/app_xmy/jinjian?productId='+productId+'&productUserId='+productUserId+'&repay='+_this.repay;
                                    } else {
            ...
            goOrder () {
                window.location.href = '/api/static/bjym/module/order.html?token='+  this.token + '&userId='+this.userId;
            },
